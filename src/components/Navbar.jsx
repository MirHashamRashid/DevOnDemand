  ...
  return (
    <nav className="fixed bottom-2 z-20 lg:bottom-4 w-full">
      <div className="container mx-auto">
        <div className="bg-black/10 dark:white/10 rounded-full flex justify-between items-center  h-[96px] max-w-[460px] mx-auto  px-5 text-2xl text-black dark:text-white">
          <Link
            to="home"
            activeClass="active"
            smooth={true}
