  ...
  return (
    <div className='flex bg-slate-100 justify-between  h-screen items-center pt-2'>
        ...
        <div className=' flex  mx-auto flex-col'>
            ...
            <div className='flex flex-col items-center lg:items-start mx-auto bg-slate-50 px-8 py-10 rounded-2xl drop-shadow-xl  justify-center '>
                <h2 className='text-black'>Register</h2>
                <hr className='h-1 w-20  bg-slate-100 mb-4'/> 
                <form className='flex flex-col' action="">
                    <input className='bg-transparent mb-2 border p-2 w-[300px] lg:w-[450px] lg:p-4 text-left text-black rounded-lg' type="text" name='name'  placeholder='Name ' />
                    ...
                    <br />
                    <button type='submit' className='bg-black my-4'>Register</button>
